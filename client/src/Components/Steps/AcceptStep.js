      ...
      if (nextProps.currentGoalSteps.length > this.props.currentGoalSteps.length) {
          ...
          !stepObj.id ? id = 'x' : id = stepObj.id
            ...
            if (!stepObj.originalId && id !== "x") {
              ...
              .then(({data}) => {
                console.log('%cUpdate Position Index && Assign OrginalId', "color: green", data)
              })
              ...
              .then(({data}) => {
                console.log('%cCreate Step', "color: green", data)
              ...
              .then(({data}) => {
                console.log('%cUpdate Position Index Only', "color: green", data)
              })
            .catch((error) => {
              console.log(error)
            })
